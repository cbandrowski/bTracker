  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed bottom-6 right-6 z-50 bg-gradient-to-r from-amber-600 to-purple-600 text-white p-4 rounded-full shadow-2xl hover:shadow-purple-500/50 transition-all hover:scale-110"
      ...
      <div
        ...
        `}
      >
        <div className="bg-slate-800/95 lg:bg-slate-800/50 backdrop-blur-md shadow-2xl rounded-none lg:rounded-xl border-r lg:border border-purple-500/30 overflow-hidden h-full">
          {/* Mobile header */}
          <div className="lg:hidden px-4 py-4 border-b border-purple-500/30">
            <h2 className="text-lg font-bold text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-purple-400">
              Navigation
            </h2>
          </div>
