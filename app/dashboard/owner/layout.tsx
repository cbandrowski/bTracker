...
export default function OwnerLayout({ children }: { children: React.ReactNode }) {
  ...
  const menu = [
    ...
    {
      label: 'Schedule',
      link: '/dashboard/owner/schedule-jobs',
      icon: (
        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" className="w-5 h-5">
    ...
    {
      label: 'Time Ledger',
      link: '/dashboard/owner/schedule-and-time/schedule-shifts',
      icon: (
        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" className="w-5 h-5">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-slate-900 to-violet-950 py-8 print:py-0 print:bg-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8 print:px-0 print:max-w-none relative z-10">
        {/* Header */}
        <div className="bg-slate-800/50 backdrop-blur-md shadow-2xl rounded-xl border border-purple-500/30 mb-4 sm:mb-6 print:hidden">
          <div className="px-3 sm:px-6 py-4 sm:py-5 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 sm:gap-3 mb-1">
                ...
                <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-purple-400 truncate">
                  Guild Master Hall
                </h1>
              </div>
              <p className="mt-1 text-xs sm:text-sm text-purple-200 truncate">
