        ...
        <div className="flex items-center justify-center py-12">
          <div className="text-center">
            ...
            <p className="text-gray-400 max-w-md">
              The assignments feature is currently under development. You'll be able to view tasks assigned to you, update their status, and submit completed work here.
            </p>
