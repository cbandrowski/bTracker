        ...
        <div className="flex items-center justify-center py-12">
          <div className="text-center">
            ...
            <p className="text-gray-400 max-w-md">
              The job board feature is currently under development. You'll be able to view available positions, apply for internal opportunities, and track your applications here.
            </p>
